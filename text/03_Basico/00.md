...
Continuando, veremos alguns hábitos desaceleradores. É o hábito da vocalização e do retrocesso (por falta de atenção). Eles acontecem, muitas vezes, pela falta de consciência de que a leitura é uma habilidade, como qualquer outra, que não só pode como deve ser treinada.
